...
public class vertodoFragment extends Fragment {
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vista) {
                if(listDatos.get(recyler.getChildAdapterPosition(vista)).getStatus().equals("Pendiente")) {
                    ...
                    String texto2= cn.aprobar("http://natanael13.000webhostapp.com/update.php",listDatos.get(recyler.getChildAdapterPosition(vista)).getNombre());
                }
                    ...
                    String texto2= cn.rechazar("http://natanael13.000webhostapp.com/desupdate.php",listDatos.get(recyler.getChildAdapterPosition(vista)).getNombre());
    ...
    public void ActualizarAdapter(){
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vista) {
                ...
                //"Aprobo la solicitud de: " + listDatos.get(recyler.getChildAdapterPosition(vista)).getNombre(), Toast.LENGTH_SHORT).show();
                //String texto2= cn.delete("http://neuroexpansion.000webhostapp.com/update.php",listDatos.get(recyler.getChildAdapterPosition(vista)).getNombre());
                ActualizarAdapter();
            }
        });
        recyler.setAdapter(adapter);
    ...
    private void llenarPersonajes() {
     ...
     /*   listDatos.add(new Usuarios("Ivan","20/12/19","8:00","Oficina","Pendiente"));
        listDatos.add(new Usuarios("pop","20/12/19","8:00","Oficina","Pendiente"));
        listDatos.add(new Usuarios("kkk","20/12/19","8:00","Oficina","Pendiente"));
        listDatos.add(new Usuarios("sopa","20/12/19","8:00","Oficina","Pendiente"));
        listDatos.add(new Usuarios("du","20/12/19","8:00","Oficina","Pendiente"));
        listDatos.add(new Usuarios("makako","20/12/19","8:00","Oficina","Pendiente"));
*/
        ...
        int c = 1;
            for (int i = 1; i <= cont; i++) {
               listDatos.add(new Usuarios(dato[c],dato[c+1],dato[c+2],dato[c+3],"Pendiente"));
                c = c + 4;
            }
